...
namespace LombdaAgentSDK.Utility
{
    public class ChromaV2ClientHandler : DelegatingHandler
    {
        public static ChromaV2ClientHandler V2handler = new ChromaV2ClientHandler
        {
